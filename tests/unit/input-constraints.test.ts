...
describe('calculator input constraints', () => {
  ...
  it('exposes Excel-compatible purlin presentation metrics', () => {
    ...
    expect(result.lstkMp350Top[0]?.excelMetrics?.lineLabel).toBe('2TPS')
    expect(result.lstkMp350Top[0]?.excelMetrics?.unitMassPerMeterKg).toBeCloseTo(11.43, 2)
    expect(result.lstkMp350Top[0]?.excelMetrics?.massPerMeterKg).toBeCloseTo(5.7143, 4)
    expect(result.lstkMp350Top[0]?.excelMetrics?.massPerStepKg).toBeCloseTo(1645.7184, 4)
    expect(result.lstkMp350Top[0]?.excelMetrics?.massWithBracesKg).toBeCloseTo(16852.1472, 4)
    expect(result.lstkMp390Top[0]?.excelMetrics?.massWithBracesKg).toBeCloseTo(15755.0016, 4)
  })
})
